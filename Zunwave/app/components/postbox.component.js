...
define(["require", "exports", '@angular/core', '../services/api.service', '../dataflip.typings'], function (require, exports, core_1, api_service_1, dataflip_typings_1) {
    "use strict";
    var PostBoxComponent = (function () {
        ...
        PostBoxComponent.prototype.handleClick = function () {
            var _this = this;
            var params = new dataflip_typings_1.Context.CreateActivity_Parameters();
            params.content = this.content;
            params.userId = 1;
            params.activityImage = "noimage";
            params.activityType = "POST";
            this._service.createActivity(params).subscribe(function () { return _this.onPost.emit("created"); });
        };
